...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('July 9, 2022 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Sabtu, 9 Juli 2022", "Shalom,", "Hai Zefanya apa kabar? udah lama gak ketemu sama kamu...", "Semoga kamu sehat selalu yaa^^", "Ohh iya lewat surat ini aku mau ngucapin", " ", "<b>Selamat Ulang Tahun Yang ke - 18</b>", " ", "Kepada Zefanya Sherafim, semoga kamu panjang umur, dan bahagia selalu. Aamiin. Sekian surat pernyataan dari aku.", , " ", " ", "- Harley Wikasa"],
  startDelay: 6000,
  speed: 80,
...
new TypeIt("#teks2", {
  strings: ["Haii Anyaa Chan!!", "Happy Birthday yaa..", "Ciie udah 18 tahun, nggak terasa udh mau 1 tahun kita kenalan hehe, semoga di umur yang sekarang kamu bisa jadi pribadi yang lebih baik lagi, lebih rajin, dan lebih berbakti.", "Maaf ya aku gabisa kasih surprise yang lebih bagus. Cuma ini yang bisa aku kasih ke kamu, aku harap kamu suka ya :)", " ", "Sekali lagi, Selamat Ulang Tahun yaa Anyaa. Semoga semua impian, keinginan, dan harapan kamu bisa tercapai, aku jg berdoa agar Tuhan Yesus selalu memberkati dan menjagamu di setiap waktu, Aamiin."],
  startDelay: 3000,
  speed: 75,
  waitUntilVisible: true
}).go();
